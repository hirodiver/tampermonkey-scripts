...
**未確認の点**: 最初の投稿は y162（＝106+56）から始まっていた。Xが枠の大きさを
見てタイムラインの位置を決めていれば、枠を0にすれば投稿も上がる。そうでなければ
枠は消えても投稿の開始位置が変わらない。これは実機でしか確かめられない。
...
そのまま再現し、iPhone 相当の幅（390px）で27項目を確認する。帯が待たずに消える／
